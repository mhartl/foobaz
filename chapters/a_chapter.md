...
| `POST` | /users | `create` | create a new user [This is a link](http://example.com) |
...
[^sample-footnote]: This is a footnote. It is numbered automatically. [This is a link](http://example.com)
